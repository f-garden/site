<script lang="ts">
	...
	const projects = [{ name: 'Rede Memória', url: 'https://redememoria.org/' }];
	const links = [
		{ name: 'e-mail', url: 'mailto:f.garden.lx@gmail.com' },
		{ name: 'Instagram', url: 'https://www.instagram.com/f.gardn/' }
	];
</script>
